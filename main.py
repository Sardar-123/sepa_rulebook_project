...
from src.analyzers.impact_analyzer import generate_impact_summary_and_test_scenarios
import pandas as pd

def main():
    # Parse XSD files
    old_elements = parse_xsd('data/old_version/EPC115-06_2021_V1.0_pacs.008.001.02_Update.xsd')
    new_elements = parse_xsd('data/new_version/EPC115-06_2023_V1.0_pacs.008.001.08_Update.xsd')
    ...
    with open('data/impacts/impact_summary.txt', 'w') as f:
        f.write(impact_summary)
        
    with open('data/impacts/test_scenarios.txt', 'w') as f:
